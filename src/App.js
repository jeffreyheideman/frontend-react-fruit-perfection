    ...
    return (
        <>
            ...
            <header>
                ...
                <button
                    type="button"
                    onClick={() => console.log("Jij wil shoppen!")}>Shop nu
                </button>
            </header>
            <main>
                <Product image={citroenen} name="Citroenen"
                ...
                <Product image={limoenen} name="Limoenen"
                ...
                <Product image={ijsblokjes} name="Ijsblokjes"
